...
{
$_SESSION['msg1']="Eski Şifreniz Sistemdekiyle uyuşmamaktadır!!";
}
}
?>
<!DOCTYPE html>
...
{
alert("Şu anki şifre bölümünü doldurunuz !!");
document.chngpwd.cpass.focus();
return false;
}
else if(document.chngpwd.npass.value=="")
{
alert("Yeni şifre bölümünü doldurunuz !!");
document.chngpwd.npass.focus();
return false;
}
else if(document.chngpwd.cfpass.value=="")
{
alert("şifreyi onayla bölümünü doldurunuz !!");
