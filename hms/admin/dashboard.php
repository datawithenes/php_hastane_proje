...
{
?>
											Toplam Kullanıcılar :<?php echo htmlentities($num_rows);  } ?>		
												</a>
											</p>
										</div>
									</div>
...
{
?>
											Toplam Doktorlar :<?php echo htmlentities($num_rows1);  } ?>		
												</a>
...
{
?>
											Toplam Randevular :<?php echo htmlentities($num_rows2);  } ?>	
												</a>
												</a>
											</p>
										</div>
...
{
?>
Toplam Hasta Sayısı :<?php echo htmlentities($num_rows);  
} ?>		
</a>
											</p>
										</div>
...
?>
											Toplam Yeni Sorgular :<?php echo htmlentities($num_rows22);   ?>	
												</a>
												</a>
											</p>
										</div>
