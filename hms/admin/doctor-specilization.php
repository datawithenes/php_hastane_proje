...
$_SESSION['msg']="Doktor Uzmanlık alanı başarıyla eklendi !!";
}
...
<html lang="en">
	<head>
		<title>Admin | Doktor Uzmanlık Alanı</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Doktor Uzmanlık Alanı Ekle</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
									...
									<li class="active">
										<span>Doktor Uzmanlık Alanı Ekle</span>
									</li>
								</ol>
							</div>
						</section>
						...
						<div class="container-fluid container-fullw bg-white">
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Doktor Uzmanlık Alanı</h5>
												</div>
							...
							<input type="text" name="doctorspecilization" class="form-control"  placeholder="Enter Doctor Specialization">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Yönet <span class="text-bold">Doktor Uzmanlık Alanı</span></h5>
