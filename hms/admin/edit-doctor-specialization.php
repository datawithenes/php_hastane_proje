...
$_SESSION['msg']="Doktor Bilgisi Başarıyla Güncellendi !!";
} 
...
<html lang="en">
	<head>
		<title>Admin | Doktor Bilgisi Düzenle</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Doktor Bilgisi Düzenle</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
									...
									<li class="active">
										<span>Doktor Bilgisi Düzenle</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Doktor Bilgisi Düzenle</h5>
												</div>
