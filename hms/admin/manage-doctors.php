...
<html lang="en">
	<head>
		<title>Admin | Doktor Bilgilerini Yönet</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Doktor Bilgilerini Yönet</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
									...
									<li class="active">
										<span>Doktor Bilgilerini Yönet</span>
									</li>
								</ol>
							</div>
						</section>
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Doktor Bilgilerini <span class="text-bold">Yönet</span></h5>
