...
if($query){
echo "<script>alert('Admin Düzenlemesi Başarıyla Güncellendi.');</script>";
...
<html lang="en">
	<head>
		<title>Admin | Mesaj Detayları</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Mesaj Detayları</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Yönet <span class="text-bold">Mesaj Detayları</span></h5>
