...
{
$_SESSION['msg1']="Eski Parola eşleşmiyor !!";
}
}
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<title>Doktor  | Parola Değiştir</title>
...
{
alert("Şu Anki Şifre Bölümü Boş Olamaz !!");
document.chngpwd.cpass.focus();
return false;
}
else if(document.chngpwd.npass.value=="")
{
alert("Yeni Şifre Bölümü Boş Olamaz !!");
document.chngpwd.npass.focus();
return false;
}
else if(document.chngpwd.cfpass.value=="")
{
alert("Şifreyi Onayla Bölümü Boş Olamaz !!");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Doktor | Parola Değiştir</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Doktor</span>
