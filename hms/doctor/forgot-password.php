...
echo "<script>alert('Bilgileriniz Yanlış Görünüyor Tekrar deneyiniz.');</script>";
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../index.html"><h2> SOS | Şifre Kurtartma</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							...
							<p>
								Şifrenizi Kurtarmak için Email ve Telefon numaranızı Giriniz.<br />
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> SOS</span>. <span>Tüm Hakları Saklıdır.</span>
					</div>
