...
<html lang="en">
	<head>
		<title>Sağlık Ocağı Sistemi</title>
		<meta charset="UTF-8">
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Kullanıcılar | Sağlık Geçmişi</h1>
</div>
<ol class="breadcrumb">
<li>
...
<li class="active">
<span>Muayne Geçmişine Gözat</span>
</li>
</ol>
</div>
</section>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15"> <span class="text-bold">Muayne Geçmişi</span></h5>
